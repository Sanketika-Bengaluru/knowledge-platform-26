...
object ContentConstants {
    ...
    val PUBLIC_CHECK_LIST: String = "publishChecklist"
    val PUBLISH_TYPE: String = "publish_type"
    val PUBLISH_STATUS: String = "publishStatus"
    val ID: String = "id"
    val TYPE: String = "type"
    val SYSTEM: String = "System"
    val P_DATA: String = "pdata"
    val SUNBIRD_PLATFORM: String = "org.sunbird.platform"
    val VER: String = "ver"
    val LAST_PUBLISHED_BY: String = "lastPublishedBy"
